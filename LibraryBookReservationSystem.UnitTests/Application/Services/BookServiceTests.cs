...
namespace LibraryBookReservationSystem.Tests.Application.Services;

public class BookServiceTests
{
   private readonly Mock<IBookRepository> _mockRepo;
   private readonly Mock<ILogger<LibraryBookReservationSystem.Application.Services.BookService>> _mockLogger;
   private readonly LibraryBookReservationSystem.Application.Services.BookService _sut;

   public BookServiceTests()
   {
      _mockRepo = new Mock<IBookRepository>();
      _mockLogger = new Mock<ILogger<LibraryBookReservationSystem.Application.Services.BookService>>();
      _sut = new LibraryBookReservationSystem.Application.Services.BookService(_mockRepo.Object, _mockLogger.Object);
   }
