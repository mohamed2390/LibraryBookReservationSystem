...
namespace LibraryMemberSystem.Tests.Application.Services;
...
public class MemberServiceTests
{
   ...
   private readonly Mock<ILogger<LibraryMemberSystem.Application.Services.MemberService>> _mockLogger;
   private readonly IMemberService _sut; 
   ...
   public MemberServiceTests()
   {
      ...
      _mockLogger = new Mock<ILogger<LibraryMemberSystem.Application.Services.MemberService>>();
      _sut = new LibraryMemberSystem.Application.Services.MemberService(_mockRepo.Object, _mockTokenService.Object, _mockPasswordHasher.Object, _mockLogger.Object);
   }
   ...
   public async Task RegisterAsync_ShouldSucceed_WhenUsernameIsUnique()
   {
      ...
      result.Equals("User registered:" + dto.Username + "Successfully");
